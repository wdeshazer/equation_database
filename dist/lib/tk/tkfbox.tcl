...
proc ::tk::dialog::file::Config {dataName type argList} {
    ...
    # The "-confirmoverwrite" option is only for the "new_from_source" file dialog.
    #
    if {$type eq "new_from_source"} {
...
proc ::tk::dialog::file::Done {w {selectFilePath ""}} {
	...
	if {($data(type) eq "new_from_source") && $data(-confirmoverwrite) && [file exists $selectFilePath]} {
