...
EquationRecord = namedtuple('EquationRecord', ['code_file_path', 'insertion_order', 'insertion_order_prev',
...
class Equation(GroupedPhysicsObject):
    ...
    def __init__(self, *args, table_name='equation', parent_table_name='eqn_group', verbose: bool = False, **kwargs):
        ...
        if len(self.grouped_data.index) == 0:
            ...
            ltx = LatexData(latex=r'\Sigma \Nu = \int_{0}^{1} \frac{x^4 \left(1 - x \right)^4 }{1 + x^2} dx')
