...
class Unit(MathObject):
    ...
    def __init__(self, table_name='unit', parent_table_name=None, verbose: bool = False):
        """Constructor for Unit. Relations are one to many"""
        super().__init__(table=table_name, parent_table=parent_table_name, verbose=verbose)
